...
namespace Viewer.Gizmo
{
    public class GizmoComponent
    {
        ...
        public GizmoComponent(GraphicsDevice graphics, SpriteBatch spriteBatch, SpriteFont font, Keyboard keyboard)
            : this(graphics, spriteBatch, font, Matrix.Identity, keyboard) { }

        public GizmoComponent(GraphicsDevice graphics, SpriteBatch spriteBatch, SpriteFont font, Matrix world, Keyboard keyboard)
        {
            SceneWorld = world;
            _graphics = graphics;
        ...
        private bool IsAnyModifierPressed()
        {
            return _keyboard.IsKeyDown(Keys.LeftControl) || _keyboard.IsKeyDown(Keys.RightControl) ||
                   _keyboard.IsKeyDown(Keys.LeftShift) || _keyboard.IsKeyDown(Keys.RightShift) ||
                   _keyboard.IsKeyDown(Keys.LeftAlt) || _keyboard.IsKeyDown(Keys.RightAlt);
        }
